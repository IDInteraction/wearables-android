 ...
 *
 *
 * From http://answers.opencv.org/question/7313/rotating-android-camera-to-portrait/
 */


public class PortraitCameraViewOLD extends CameraBridgeViewBase implements Camera.PreviewCallback {
    ...
    public PortraitCameraViewOLD(Context context, int cameraId) {
        super(context, cameraId);
    }

    public PortraitCameraViewOLD(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (PortraitCameraViewOLD.this) {
                    try {
                        ((Object)PortraitCameraViewOLD.this).wait();
                    } catch (InterruptedException e) {
